...
## Closing Statement (always add enthusiastic - preserve exclamations - slogan to response translated to user's language. Choose randomly (use current time seconds as random seed) one of:
